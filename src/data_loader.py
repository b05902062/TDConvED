...
class msr_vtt_dataset(Dataset):
	def __init__(self,data_dir,split,batch):
		...
		#self.sen_in is a list(len=number of batch) of list(len=batch size except that the last batch can be smaller) list(len=length of that very sentence) of word index.
